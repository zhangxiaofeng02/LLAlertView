...
+ (instancetype)actionWithTitle:(NSString *)aTitle style:(LLAlertActionStyle)aStyle handler:(LLAlertBlock)aHandler {
    LLAlertAction *tempAction = [LLAlertAction new];
...
#error Unsupported CPU
            ...
            if (alertAction && !*alertAction) {
                Class class = objc_allocateClassPair([LLAlertAction class], "UIAlertAction", 0);
                if (class) {
